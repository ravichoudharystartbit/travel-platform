...
const SignUp = () => {
  ...
  return (
    <section className="bg-[#F4F7FF] py-14 dark:bg-[#102C46] lg:py-[90px]">
              ...
              {isPassword ? (
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-9">
                    <button
                      type="submit"
                      className="flex w-full cursor-pointer items-center justify-center rounded-md border border-primary bg-[#102C46] px-5 py-3 text-base text-white transition duration-300 ease-in-out hover:bg-blue-dark"
                    >
